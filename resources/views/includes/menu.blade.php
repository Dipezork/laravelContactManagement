...
<body class="nav-fixed">
    <nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white"
        ...
        <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="{{ route('contacts.index') }}">Exercicio Laravel</a>
        <!-- Navbar Search Input-->
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <div class="sidenav-menu-heading">Cadastro De Contato</div>
                        <!-- Sidenav Accordion (Dashboard)-->
                        <a class="nav-link collapsed" href="javascript:void(0);" data-bs-toggle="collapse"
                            data-bs-target="#collapseDashboards2" aria-expanded="false"
                            aria-controls="collapseDashboards2">
                            <div class="nav-link-icon"><i data-feather="activity"></i></div>
                            Contato
                            <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                        </a>
                        <div class="collapse" id="collapseDashboards2" data-bs-parent="#accordionSidenav2">
                        ...
                        <div class="sidenav-footer">
                            <div class="sidenav-footer-content">
                                ...
                                @if (auth()->user()->role_id == 2)
                                    <div class="text-success">Usuário autenticado (Com permissões)</div>
                                @else
                                    <div class="text-danger">Não é um usuário autenticado (Sem permissões)</div>
                                @endif
